			...
			<div class="row">
				...
				<div class="col-lg-4 teacher">
					<div class="card">
						...
						<div class="card-body text-center">
							<div class="card-title"><a href="#">Asst. Prof. Dr. Ammar E. Abdulmalek</a></div>
				...
				<div class="col-lg-4 teacher">
					<div class="card">
						...
						<div class="card-body text-center">
							<div class="card-title"><a href="#">Asst. Lecturer Mustafa A. Naima</a></div>
							<div class="teacher_social">
								<ul class="menu_social">
									<li class="menu_social_item"><a href="#"><i class="fab fa-pinterest"></i></a></li>
									<li class="menu_social_item"><a href="#"><i class="fab fa-linkedin-in"></i></a></li>
				...
				<div class="col-lg-4 teacher">
					<div class="card">
						...
						<div class="card-body text-center">
							<div class="card-title"><a href="#">Dr. Laheib M. Jwad</a></div>
							<div class="teacher_social">
								<ul class="menu_social">
									<li class="menu_social_item"><a href="#"><i class="fab fa-pinterest"></i></a></li>
									<li class="menu_social_item"><a href="#"><i class="fab fa-linkedin-in"></i></a></li>
				...
				<div class="col-lg-4 teacher">
					<div class="card">
						...
						<div class="card-body text-center">
							<div class="card-title"><a href="#">Prof. Dr. Nasr N. Khamis</a></div>
							<div class="teacher_social">
								<ul class="menu_social">
									<li class="menu_social_item"><a href="#"><i class="fab fa-pinterest"></i></a></li>
									<li class="menu_social_item"><a href="#"><i class="fab fa-linkedin-in"></i></a></li>
				...
				<div class="col-lg-4 teacher">
					<div class="card">
						...
						<div class="card-body text-center">
							<div class="card-title"><a href="#">Asst. Lecturer Raya Kahtan</a></div>
							<div class="teacher_social">
								<ul class="menu_social">
									<li class="menu_social_item"><a href="#"><i class="fab fa-pinterest"></i></a></li>
									<li class="menu_social_item"><a href="#"><i class="fab fa-linkedin-in"></i></a></li>
				...
				<div class="col-lg-4 teacher">
					<div class="card">
						...
						<div class="card-body text-center">
							<div class="card-title"><a href="#">Prof. Dr. Hikmat N. Abdullah</a></div>
							<div class="teacher_social">
								<ul class="menu_social">
									<li class="menu_social_item"><a href="#"><i class="fab fa-pinterest"></i></a></li>
									<li class="menu_social_item"><a href="#"><i class="fab fa-linkedin-in"></i></a></li>
				...
				<div class="col-lg-4 teacher">
					<div class="card">
						<div class="card_img">
							<div class="card_plus trans_200 text-center"><a href="#">+</a></div>
							<img class="card-img-top trans_200" src="/images/teacher_7.jpg" alt="https://unsplash.com/@mehdizadeh">
						</div>
						<div class="card-body text-center">
							<div class="card-title"><a href="#">Asst. Prof. Dr. Mohammed F Abdulkareem</a></div>
							<div class="teacher_social">
								<ul class="menu_social">
									<li class="menu_social_item"><a href="#"><i class="fab fa-pinterest"></i></a></li>
									<li class="menu_social_item"><a href="#"><i class="fab fa-linkedin-in"></i></a></li>
				...
				<div class="col-lg-4 teacher">
					<div class="card">
						<div class="card_img">
							<div class="card_plus trans_200 text-center"><a href="#">+</a></div>
							<img class="card-img-top trans_200" src="/images/teacher_8.jpg" alt="https://unsplash.com/@mehdizadeh">
						</div>
						<div class="card-body text-center">
							<div class="card-title"><a href="#">Asst. Prof. Dr. Mohammed F Abdulkareem</a></div>
							<div class="teacher_social">
				...
				<div class="col-lg-4 teacher">
					<div class="card">
						<div class="card_img">
							<div class="card_plus trans_200 text-center"><a href="#">+</a></div>
							<img class="card-img-top trans_200" src="/images/teacher_9.jpg" alt="https://unsplash.com/@mehdizadeh">
						</div>
						<div class="card-body text-center">
							<div class="card-title"><a href="#">Asst. Prof. Dr. Mohammed F Abdulkareem</a></div>
							<div class="teacher_social">
			...
			<div class="row">
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						...
						<div class="milestone_counter" data-end-value="364">0</div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						...
						<div class="milestone_text">Faculty Member</div>
					</div>
				</div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						...
						<div class="milestone_text">Academic Programs</div>
					</div>
				</div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						...
						<div class="milestone_counter" data-end-value="672" data-sign-before="+">0</div>
